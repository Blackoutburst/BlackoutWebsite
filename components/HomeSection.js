    ...
    return (
        <div className={"flex justify-between bg-[#130c1c] -z-50 w-full h-56 xl:h-full"}>
            ...
            <div className={"select-none hidden xl:flex relative justify-center items-center opacity-70 mt-32 z-40"}>
                <Image width={2048} height={2048} alt={"logo"} className={"w-56 h-56 rounded-full z-20"} src={"/logo.webp"} priority/>
                <div className={"absolute bg-gradient-to-r from-[#452277] to-[#9061d1] w-60 h-60 rounded-full shadow-2xl z-10"} />
                <Image width={0} height={0} alt={"logo"} className={"absolute w-96 h-96 coil"} src={"/coil.svg"}/>
            </div>
